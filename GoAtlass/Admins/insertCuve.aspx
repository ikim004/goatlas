<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="insertCuve.aspx.cs" Inherits="GoAtlass.Admins.insertCuve" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        <h1 style="font-weight: 600; font-style: oblique;margin-top:3%; margin-bottom:2.25%; color:#2D3250;">Ajouter Une Cuve </h1>
  ...
  &nbsp;<asp:TextBox ID="Capacity" runat="server" class="form-control"></asp:TextBox>
   ...
   <div>
       <asp:Button ID="insertCuve" runat="server" Text="Ajouter" class="btn btn-success"  Style="margin-top:2% ; width:100px" OnClick="insertVille_Click" />
   </div>
